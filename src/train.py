...
tf.flags.DEFINE_string("train_dir", './model/train1',
...
tf.flags.DEFINE_integer("num_train_inst", 457864, "Number of training instances")
...
tf.flags.DEFINE_string("Glove_path", './data/output1', "Path to Glove dictionary")
